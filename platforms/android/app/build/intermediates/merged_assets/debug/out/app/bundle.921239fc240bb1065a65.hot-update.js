    ...
    getUpcomingMatchDetails() {
      ...
      return _asyncToGenerator(function* () {
        ...
        if (result && !result.isError) {
          ...
          var matchDetails = result.json && Object.values(result.json.match);
