    ...
    getUnreadMatchCount() {
      ...
      return _asyncToGenerator(function* () {
        ...
        if (result && !result.isError) {
          ...
          _this3.$set(_this3.state, 'count', result.json.count); // this.state = Object.assign({}, this.state, { 'count': result.json.count })
